...
class AdminController
{
    ...
    {
        $this->Controller->getHeader("Admin Delete page");
    ...
    {
        $this->Controller->getHeader("Admin Update page");
    ...
    {
        $this->Controller->getHeader("Admin Create page");
